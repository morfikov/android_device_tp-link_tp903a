...
LOCAL_PATH := device/tp-link/tp903a
...
TARGET_OTA_ASSERT_DEVICE := tp903a,X1_Max
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE   :=  0xDD800000 # (~3.5 GiB)
BOARD_CACHEIMAGE_PARTITION_SIZE    :=  0x1B000000 # (432 MiB)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0x6403FBE00 # (~25 GiB)
